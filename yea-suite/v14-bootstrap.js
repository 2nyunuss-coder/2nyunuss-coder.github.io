...
(()=>{
  ...
  const wait=()=>window.YeaBoot.waitUntil(()=>window.__YEA_V13_BOOTED&&window.v13AppOpen&&document.querySelector('#v13Desktop')&&document.querySelector('#v13PdfPageNo'),setup);
  function setup(){
    ...
    if(!document.querySelector('#v14WindowLayer'))document.body.insertAdjacentHTML('beforeend',`<div id="v14WindowLayer" class="v14WindowLayer"></div><div id="v14FilesWindow" class="v14Window hidden" data-v14-window="files"><div class="v14WinBar"><b>🗃 Dosya Yöneticisi</b><div><button data-v14-min="files">—</button><button data-v14-max="files">□</button><button data-v14-close="files">✕</button></div></div><div class="v14WinBody"><div class="v14WinFilesBar"><button id="v14WinFilesFull" type="button">Tam Ekran Dosyalar</button><button id="v14WinFilesRefresh" type="button" class="ghost">↻</button></div><div id="v14WinFileGrid" class="v14FileGrid"></div></div><div class="v14Resize"></div></div><div id="v14TrashWindow" class="v14Window hidden" data-v14-window="trash"><div class="v14WinBar"><b>🗑 Çöp Kutusu</b><div><button data-v14-min="trash">—</button><button data-v14-max="trash">□</button><button data-v14-close="trash">✕</button></div></div><div class="v14WinBody"><div class="v14TrashActions"><button id="v14TrashEmpty" type="button" class="danger">Çöp Kutusunu Boşalt</button></div><div id="v14TrashList" class="v14TrashList"></div></div><div class="v14Resize"></div></div>`);
