'use strict';
const PREFIX='yea-arcade-3d-',CACHE=PREFIX+'arcade-v4-20260911';
const CORE=['./','./index.html','./v2.html','./v3.html','./v4.html','./app3d-v4.js','./worlds-v4.js','./input-v4.js','./audio-v4.js','./arcade-v4.css','./redirect.js','./app3d.css','./app3d.js','./app3d-v3.js','./studio-models-v3.js','./studio-worlds-v3.js','./studio-v3.css','./castle3d.js','./world3d.js','./engine.js','./manifest.webmanifest','./app-icon.svg','./icons/icon-180.png','./icons/icon-192.png','./icons/icon-512.png','../install.js','../install.css'];
...
self.addEventListener('fetch',event=>{
  ...
  event.respondWith((async()=>{const cache=await caches.open(CACHE);const cached=await cache.match(req,{ignoreSearch:true});
    if(req.mode==='navigate'){try{const response=await fetch(req);if(response.ok){cache.put(req,response.clone());return response;}return cached||response;}catch{return cached||cache.match('./v4.html');}}
